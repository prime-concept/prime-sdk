...
class AnyUpdatableTableViewCell<ViewModel>: UITableViewCell {
...
class TileTableViewCell<T: BaseTileView, ViewModel>: AnyUpdatableTableViewCell<ViewModel>, ViewHighlightable {
